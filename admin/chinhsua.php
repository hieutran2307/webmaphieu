	...
	<form action="chinh-sua-thanh-vien.php" method="post">
		<table>
			...
			<tr>
				...
				<td><input name="tieude" id="tieude" value="<?php echo $data['fullname']; ?>" ></td>
			</tr>
			<tr>
				<td nowrap="nowrap">Nội dung bài viết :</td>
				<td><input type="text" id="noidung" name="noidung" value="<?php echo $data['email']; ?>"></td>
			</tr>
